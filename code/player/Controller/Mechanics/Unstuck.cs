...
using Sandbox;
namespace Sandmbit;
public class UnstuckComponent : EntityComponent<Pawn>
{
	...
	public virtual bool TestAndFix()
	{
		...
		{
			return false;
			//if ( player.Controller.HasTag( "noclip" ) ) return false;
	...
	*/
	...
	public virtual TraceResult TraceBBox( Vector3 start, Vector3 end, float liftFeet = 0.0f )
	{
		...
		//{
		//	if ( ply.Controller is WalkMechanic walk )
		//	{
		//		return TraceBBox( start, end, walk.mins, walk.maxs, liftFeet );
		//	}
		//}
		return TraceBBox( start, end, (Entity as Pawn).CollisionBounds.Mins, (Entity as Pawn).CollisionBounds.Maxs, liftFeet );
	}
