...
public partial class WeaponComponent : EntityComponent<Weapon>
{
	...
	protected Pawn Player => Weapon.Owner as Pawn;
	...
	protected virtual void OnStart( Pawn player )
	{
	...
	protected virtual bool CanStart( Pawn player )
	{
		return true;
	}
	...
	/// <param name="cl"></param>
	/// <param name="player"></param>
	public virtual void Simulate( IClient cl, Pawn player )
	{
		var before = IsActive;
	...
	/// </summary>
	/// <param name="player"></param>
	protected virtual void OnStop( Pawn player )
	{
		if ( UseGameEvents )
